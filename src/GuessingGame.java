...
public class GuessingGame {
    ...
    public static void Game()
    {
        ...
        System.out.println("Enter a number 1 to 4 to choose your difficulty");
        ...
        if (diff.equals("1"))
        {
            ...
            System.out.println("Your range of numbers is from 1 to 10, Good luck");
            int guess = 0;
            while (guess != ans)
            {
                guess = input.nextInt ();
        ...
        if (diff.equals("2"))
        {
            ...
            System.out.println("Your range of numbers is from 1 to 100, Good luck");
            int guess = 0;
            while (guess != ans)
            {
                guess = input.nextInt ();
        ...
        if (diff.equals("3"))
        {
            ...
            System.out.println("Your range of numbers is from 1 to 1000, Good luck");
            int guess = 0;
            while (guess != ans)
            {
                guess = input.nextInt ();
        ...
        if (diff.equals("4"))
        {
            ...
            System.out.println("Your range of numbers is from 1 to 10000, Good luck");
            int guess = 0;
            while (guess != ans)
            {
                guess = input.nextInt ();
